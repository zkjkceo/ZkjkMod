...
public class EntityBoatLarge extends EntityBoat {
	...
	public EntityBoatLarge(World var1) {
		super(var1);
		this.field_70279_a = true;
		this.speedMultiplier = 0.07D;
		this.preventEntitySpawning = true;
		this.setSize(3.0F, 1.2F);
	...
	public EntityBoatLarge(World var1, double var2, double var4, double var6) {
		this(var1);
	...
	public boolean attackEntityFrom(DamageSource var1, int var2) {
		if(this.isEntityInvulnerable()) {
			...
			if(var3 || this.getDamageTaken() > 40) {
				...
				if(!var3) {
					this.dropItemWithOffset(Item.boatLarge.itemID, 1, 0.0F);
				}
			...
			if(!this.worldObj.isRemote) {
				...
				if(var16 != null && !var16.isEmpty()) {
					for(var26 = 0; var26 < var16.size(); ++var26) {
						...
						if(var18 != this.riddenByEntity && var18.canBePushed() && var18 instanceof EntityBoatLarge) {
