...
public class RecipesDyes {
	public void addRecipes(CraftingManager var1) {
		...
		for(int var2 = 0; var2 < 16; ++var2) {
			var1.addShapelessRecipe(new ItemStack(Block.cloth, 1, 0), new Object[]{new ItemStack(Item.dyePowder, 1, 15), new ItemStack(Item.itemsList[Block.cloth.blockID], 1, var2)});
		}
