...
public class GuiMainMenu extends GuiScreen {
	...
	static Object func_104004_a(GuiMainMenu var0) {
		return var0.field_104025_t;
	}

	static String func_104005_a(GuiMainMenu var0, String var1) {
		return var0.field_92025_p = var1;
	}

	static String func_104013_b(GuiMainMenu var0, String var1) {
		return var0.field_104024_v = var1;
	}

	static int func_104006_a(GuiMainMenu var0, int var1) {
		return var0.field_92023_s = var1;
	}

	static String func_104023_b(GuiMainMenu var0) {
		return var0.field_92025_p;
	}

	static FontRenderer func_104022_c(GuiMainMenu var0) {
		return var0.fontRenderer;
	}

	static int func_104014_b(GuiMainMenu var0, int var1) {
		return var0.field_92024_r = var1;
	}

	static FontRenderer func_104007_d(GuiMainMenu var0) {
		return var0.fontRenderer;
	}

	static int func_104016_e(GuiMainMenu var0) {
		return var0.field_92023_s;
	}

	static int func_104015_f(GuiMainMenu var0) {
		return var0.field_92024_r;
	}

	static int func_104008_c(GuiMainMenu var0, int var1) {
		return var0.field_92022_t = var1;
	}

	static int func_104009_d(GuiMainMenu var0, int var1) {
		return var0.field_92021_u = var1;
	}

	static List func_104019_g(GuiMainMenu var0) {
		return var0.buttonList;
	}

	static int func_104011_e(GuiMainMenu var0, int var1) {
		return var0.field_92020_v = var1;
	}

	static int func_104018_h(GuiMainMenu var0) {
		return var0.field_92022_t;
	}

	static int func_104012_f(GuiMainMenu var0, int var1) {
		return var0.field_92019_w = var1;
	}

	static int func_104020_i(GuiMainMenu var0) {
		return var0.field_92021_u;
	}

	static Minecraft func_98058_a(GuiMainMenu var0) {
		return var0.mc;
	}
