...
public class EntityFishHook extends Entity {
	...
	public EntityFishHook(World var1, EntityPlayer var2) {
		...
		this.calculateVelocity(this.motionX, this.motionY, this.motionZ, 0.75F, 1.0F); //half the force
	}
	...
	public int catchFish() {
		if(this.worldObj.isRemote) {
			...
			if(this.bobber != null) {
				...
				if(this.rand.nextInt(100) == 0) { //rare drops
					ItemStack item = Item.enchantedBook.func_92109_a(rand);
					int rand_num = this.rand.nextInt(1);
					switch(rand_num) {
						case 0:
							item = Item.enchantedBook.func_92109_a(rand);
							break;
					}
					...
					this.angler.worldObj.spawnEntityInWorld(new EntityXPOrb(this.angler.worldObj, this.angler.posX, this.angler.posY + 0.5D, this.angler.posZ + 0.5D, this.rand.nextInt(11) + 10));
					var1 = 1;
				} else if (this.rand.nextInt(10) == 0) { //garbage drops
					Item type = Item.rottenFlesh;
					int rand_num = this.rand.nextInt(10);
					switch (rand_num) {
						case 0:
							type = Item.rottenFlesh;
							break;
						case 1:
							type = Item.leather;
							break;
						...
						case 8:
							...
							break;
						case 9:
							type = Item.helmetLeather;
							break;
					}
					EntityItem var13 = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(type));
					double var3 = this.angler.posX - this.posX;
					double var5 = this.angler.posY - this.posY;
					double var7 = this.angler.posZ - this.posZ;
					double var9 = (double)MathHelper.sqrt_double(var3 * var3 + var5 * var5 + var7 * var7);
					...
					Item type = Item.fishRaw; //default fish
					if(this.rand.nextInt(3) == 0) {
						type = Item.salmonRaw; //salmon
					}
					EntityItem var13 = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(type));
					double var3 = this.angler.posX - this.posX;
					double var5 = this.angler.posY - this.posY;
